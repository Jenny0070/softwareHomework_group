...
<%--                <dd class="main-list">菜品管理</dd>--%>
    ...
    <div class="sp fl">
        ...
        <div class="sp-main">
            <form action="${ctx}/admin/updateStore?storeId=${sessionScope.storeId}" id="gltest">
...
<%--                    <dd class="jb-list">--%>
<%--                        <a href="${ctx}/pages/fl.jsp">点击查看我的菜品</a><!-- 这个链接跳转到菜品的管理页面 -->--%>
<%--                    </dd>--%>
...
<%--                        ${requestScope.storeId}--%>
                ...
                <div class="btns">
                    ...
                    <a href="${ctx}/pages/gljm.jsp"><button id ="newinfo" type="submit" value="" style="width: 75px;height: 31px;">返回</button></a>
                    <button id ="again"  type="button" value="" style="width: 75px;height: 31px;"onclick="glReset();">重置</button>
                    <button type="submit" value="" style="width: 75px;height: 31px;" onclick="myCheck()">确定</button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    function glReset(){
        document.getElementById('gltest').reset();
